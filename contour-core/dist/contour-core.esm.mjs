...
var require_zrender = __commonJS({
  "node_modules/zrender/dist/zrender.js"(exports, module) {
    (function(global, factory) {
      typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = global || self, factory(global.zrender = {}));
      ...
      var Transformable = function() {
        ...
        Transformable2.prototype.decomposeTransform = function() {
          ...
          if (parent && parent.transform) {
            ...
            mul$1(tmpTransform, parent.invTransform, m2);
            m2 = tmpTransform;
          }
          var ox = this.originX;
          var oy = this.originY;
          if (ox || oy) {
            ...
            mul$1(tmpTransform, m2, originTransform);
            tmpTransform[4] -= ox;
            tmpTransform[5] -= oy;
            m2 = tmpTransform;
          }
      ...
      function fromArc(x, y, rx, ry, startAngle, endAngle, anticlockwise, min$12, max$12) {
        var vec2Min = min;
        var vec2Max = max;
        ...
        vec2Min(min$12, start, end);
        vec2Max(max$12, start, end);
        ...
        for (var angle = 0; angle < endAngle; angle += Math.PI / 2) {
          if (angle > startAngle) {
            ...
            vec2Min(min$12, extremity, min$12);
            vec2Max(max$12, extremity, max$12);
          }
        }
      }
      var CMD = {
      ...
      function containPath(path2, lineWidth, isStroke, x, y) {
        var data = path2.data;
        var len2 = path2.len();
        var w = 0;
        var xi = 0;
      ...
      function smoothBezier(points2, smooth, isLoop, constraint) {
        ...
        var max$12;
        if (constraint) {
          min$12 = [Infinity, Infinity];
          max$12 = [-Infinity, -Infinity];
          for (var i = 0, len2 = points2.length; i < len2; i++) {
            min(min$12, min$12, points2[i]);
            max(max$12, max$12, points2[i]);
          }
          min(min$12, min$12, constraint[0]);
          max(max$12, max$12, constraint[1]);
        }
        for (var i = 0, len2 = points2.length; i < len2; i++) {
          var point = points2[i];
          if (isLoop) {
      ...
      function split(path2, count) {
        ...
        switch (path2.type) {
          ...
          default:
            ...
            var polygons = map(pathToPolygons(path2.getUpdatedPathProxy(), scale2), function(poly) {
          ...
          for (var i = 0; i < morphingData.length; i++) {
            ...
            for (var m2 = 2; m2 < from.length; ) {
              ...
              if (x0 === x1 && y0 === y1 && x2 === x3 && y2 === y3) {
                ...
                path2.bezierCurveTo(x1, y1, x2, y2, x3, y3);
              }
              x0 = x3;
              y0 = y3;
            }
      ...
      function sortPaths(pathList) {
        ...
        var xMax = -Infinity;
        var yMax = -Infinity;
        var cps = map(pathList, function(path2) {
      ...
      var DropletShape = /* @__PURE__ */ function() {
      ...
      var sin = Math.sin;
      var cos = Math.cos;
      var IsogonShape = /* @__PURE__ */ function() {
      ...
      var RoseShape = /* @__PURE__ */ function() {
        function RoseShape2() {
          this.cx = 0;
          this.cy = 0;
          this.r = [];
      ...
      var cos$2 = Math.cos;
      var sin$2 = Math.sin;
      var StarShape = /* @__PURE__ */ function() {
        function StarShape2() {
          this.cx = 0;
          this.cy = 0;
          this.n = 3;
      ...
      var cos$3 = Math.cos;
      var sin$3 = Math.sin;
      var TrochoidShape = /* @__PURE__ */ function() {
      ...
      var SVGPathRebuilder = function() {
        ...
        SVGPathRebuilder2.prototype.ellipse = function(cx, cy, rx, ry, psi, startAngle, endAngle, anticlockwise) {
          ...
          var isCircle = isAroundZero$1(dThetaPositive - PI2$6) || (clockwise ? dTheta >= PI2$6 : -dTheta >= PI2$6);
      ...
      function noRotateScale(m2) {
        return isAroundZero$1(m2[0] - 1) && isAroundZero$1(m2[1]) && isAroundZero$1(m2[2]) && isAroundZero$1(m2[3] - 1);
      }
      function noTranslate(m2) {
        return isAroundZero$1(m2[4]) && isAroundZero$1(m2[5]);
      }
      ...
      exports2.Arc = Arc;
      exports2.ArcShape = ArcShape;
      exports2.BezierCurve = BezierCurve;
      exports2.BezierCurveShape = BezierCurveShape;
      exports2.BoundingRect = BoundingRect;
      exports2.Circle = Circle;
      exports2.CircleShape = CircleShape;
      exports2.CompoundPath = CompoundPath;
      exports2.Displayable = Displayable;
      exports2.Droplet = Droplet;
      exports2.DropletShape = DropletShape;
      exports2.Element = Element;
      exports2.Ellipse = Ellipse;
      exports2.EllipseShape = EllipseShape;
      exports2.Group = Group;
      exports2.Heart = Heart;
      exports2.HeartShape = HeartShape;
      exports2.Image = ZRImage;
      exports2.IncrementalDisplayable = IncrementalDisplayable;
      exports2.Isogon = Isogon;
      exports2.IsogonShape = IsogonShape;
      exports2.Line = Line;
      exports2.LineShape = LineShape;
      exports2.LinearGradient = LinearGradient;
      exports2.OrientedBoundingRect = OrientedBoundingRect;
      exports2.Path = Path;
      ...
      exports2.PolylineShape = PolylineShape;
      exports2.RadialGradient = RadialGradient;
      exports2.Rect = Rect;
      exports2.RectShape = RectShape;
      exports2.Ring = Ring;
      exports2.RingShape = RingShape;
      exports2.Rose = Rose;
      exports2.RoseShape = RoseShape;
      exports2.Sector = Sector;
      exports2.SectorShape = SectorShape;
      exports2.Star = Star;
      exports2.StarShape = StarShape;
      exports2.TSpan = TSpan;
      exports2.Text = ZRText;
      exports2.Trochoid = Trochoid;
      exports2.TrochoidShape = TrochoidShape;
      exports2.color = color;
      exports2.dispose = dispose;
      exports2.disposeAll = disposeAll;
      exports2.getElementSSRData = getElementSSRData;
      exports2.getInstance = getInstance;
      exports2.init = init;
      exports2.matrix = matrix;
      exports2.morph = morphPath$1;
      exports2.parseSVG = parseSVG;
      exports2.path = path;
      exports2.registerPainter = registerPainter;
      exports2.registerSSRDataGetter = registerSSRDataGetter;
      exports2.setPlatformAPI = setPlatformAPI;
      exports2.showDebugDirtyRect = showDebugDirtyRect;
      exports2.util = util;
...
var require_paths2 = __commonJS({
  "renderers/zrender/paths.js"(exports, module) {
    "use strict";
  ...
  "renderers/zrender/axes.js"(exports, module) {
    ...
    function drawXAxis(container, config, style) {
      ...
      for (var i = 0; i < ticks.length; i++) {
        ...
        var x = axisX + (tickValue - (config.xMin || 0)) / ((config.xMax || 100) - (config.xMin || 0)) * axisWidth;
    ...
    function drawYAxis(container, config, style) {
      ...
      for (var i = 0; i < ticks.length; i++) {
        var tickValue = ticks[i];
        var y = axisY + axisHeight - (tickValue - (config.yMin || 0)) / ((config.yMax || 100) - (config.yMin || 0)) * axisHeight;
        var tickLen = config.tickLen || 5;
        var tick = new zrender.Line({
          shape: {
            x1: axisX - tickLen,
    ...
    function drawYGrid(container, config, style) {
      ...
      for (var i = 0; i < ticks.length; i++) {
        var tickValue = ticks[i];
        var y = axisY - (tickValue - (config.yMin || 0)) / ((config.yMax || 100) - (config.yMin || 0)) * axisHeight;
        var gridLine = new zrender.Line({
          shape: {
            x1: axisX,
            y1: y,
...
// renderers/zrender/colorbar.js
var require_colorbar3 = __commonJS({
  "renderers/zrender/colorbar.js"(exports, module) {
    "use strict";
    var zrender = require_zrender();
  ...
  "renderers/zrender/index.js"(exports, module) {
    ...
    ZRenderContourRenderer.prototype.initZoom = function(options) {
      ...
      this.zr.on("mousewheel", function(e) {
        ...
        if (options.wheelEnabled === false)
          return;
        e.stop();
        self2.handleWheel(e, options);
      });
      this.zr.on("pinch", function(e) {
        if (!self2.interactionEnabled)
          return;
        if (options.pinchEnabled === false)
          return;
        e.stop();
        self2.handlePinch(e, options);
      });
    };
    ...
    ZRenderContourRenderer.prototype.initPan = function(options) {
      ...
      this.zr.on("mousedown", function(e) {
        ...
        self2.panState.lastX = e.offsetX;
      ...
      this.zr.on("mousemove", function(e) {
        if (!self2.panState.isDragging)
          return;
        var dx = e.offsetX - self2.panState.lastX;
        var dy = e.offsetY - self2.panState.lastY;
        var group = self2.mainGroup;
        var newX = group.x + dx;
        var newY = group.y + dy;
        if (options.bounds) {
        ...
        if (options.onPan) {
          options.onPan({
            dx,
            dy,
            totalDx: e.offsetX - self2.panState.startX,
            totalDy: e.offsetY - self2.panState.startY
          });
        }
      });
...
var require_labels4 = __commonJS({
...
var require_colorbar4 = __commonJS({
...
var require_contour_core = __commonJS({
  "index.js"(exports, module) {
    ...
    var contourCore = {
      ...
      // ============================================
      zrender: require_zrender2(),
      createInteractive: require_api().createInteractive,
      // ============================================
      // Utilities
      // ============================================
...
export default require_contour_core();
/*! Bundled license information:

zrender/dist/zrender.js:
  (*! *****************************************************************************
